...
const Servicio = require('../modelos/servicio'); // El modelo nuevo que creamos
...
router.post('/', autenticarToken, verificarRol('adminPrincipal'), async (req, res) => {
  try {
...
router.put('/:id', autenticarToken, verificarRol('adminPrincipal'), async (req, res) => {
    try {
...
router.delete('/:id', autenticarToken, verificarRol('adminPrincipal'), async (req, res) => {
    try {
