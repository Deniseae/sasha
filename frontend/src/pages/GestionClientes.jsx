...
const DuenosList = () => {
  ...
  const handleAgregarDueno = async () => {
    try {
      if (!nuevoDueno.nombres || !nuevoDueno.email)
        return Swal.fire({
          title: "Faltan datos",
          icon: "warning",
          background: "#1e1e1e",
  ...
  return (
    <div className="admin-container">
              ...
              <tr key={d._id}>
                <td>
                  ...
                  {d.usuarioId ? (
                    ...
                    <span className="badge-dueno">Offline</span>
                  )}
                </td>
                <td>{d.dni || "-"}</td>
                <td>
      ...
      {/* --- MODAL AGREGAR --- */}
      <Modal
        show={showAgregarDueno}
        onHide={() => setShowAgregarDueno(false)}
        centered
        backdrop="static"
      >
          ...
          <Form>
            <div className="row">
              <div className="col-6 mb-3">
                ...
                <Form.Control
                  value={nuevoDueno.nombres}
                  onChange={(e) =>
                    setNuevoDueno({ ...nuevoDueno, nombres: e.target.value })
                  }
                />
              </div>
              <div className="col-6 mb-3">
                ...
                <Form.Control
                  value={nuevoDueno.apellidos}
                  onChange={(e) =>
                    setNuevoDueno({ ...nuevoDueno, apellidos: e.target.value })
                  }
                />
              </div>
            </div>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setNuevoDueno({ ...nuevoDueno, email: e.target.value })
                }
              />
            </Form.Group>
            <div className="row">
              <div className="col-6 mb-3">
                ...
                <Form.Control
                  value={nuevoDueno.dni}
                  onChange={(e) =>
                    setNuevoDueno({ ...nuevoDueno, dni: e.target.value })
                  }
                />
              </div>
              <div className="col-6 mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setNuevoDueno({ ...nuevoDueno, telefono: e.target.value })
                  }
                />
              </div>
            </div>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setNuevoDueno({ ...nuevoDueno, direccion: e.target.value })
                }
              />
            </Form.Group>
          </Form>
        ...
        <Modal.Footer>
          <Button
            variant="secondary"
            onClick={() => setShowAgregarDueno(false)}
          >
            Cancelar
          </Button>
          <Button className="btn-neon" onClick={handleAgregarDueno}>
            Guardar
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      {/* --- MODAL EDITAR --- */}
      <Modal
        show={showEditarDueno}
        onHide={() => setShowEditarDueno(false)}
        centered
        backdrop="static"
      >
        <Modal.Header closeButton>
          ...
          <Form>
            <div className="row">
              <div className="col-6 mb-3">
                <Form.Label>Nombres</Form.Label>
                <Form.Control
                  value={duenoEditar?.nombres || ""}
                  onChange={(e) =>
                    setDuenoEditar({ ...duenoEditar, nombres: e.target.value })
                  }
                />
              </div>
              <div className="col-6 mb-3">
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                type="email"
                value={duenoEditar?.email || ""}
                onChange={(e) =>
                  setDuenoEditar({ ...duenoEditar, email: e.target.value })
                }
              />
            </Form.Group>
            <div className="row">
              <div className="col-6 mb-3">
                <Form.Label>DNI</Form.Label>
                <Form.Control
                  value={duenoEditar?.dni || ""}
                  onChange={(e) =>
                    setDuenoEditar({ ...duenoEditar, dni: e.target.value })
                  }
                />
              </div>
              <div className="col-6 mb-3">
                <Form.Label>Teléfono</Form.Label>
                <Form.Control
                  value={duenoEditar?.telefono || ""}
                  onChange={(e) =>
                    setDuenoEditar({ ...duenoEditar, telefono: e.target.value })
                  }
                />
              </div>
            </div>
            <Form.Group className="mb-3">
              <Form.Label>Dirección</Form.Label>
              <Form.Control
                value={duenoEditar?.direccion || ""}
                onChange={(e) =>
                  setDuenoEditar({ ...duenoEditar, direccion: e.target.value })
                }
              />
            </Form.Group>
          </Form>
        ...
        <Modal.Footer>
          ...
          <Button className="btn-neon" onClick={handleEditarDueno}>
            Guardar Cambios
          </Button>
        </Modal.Footer>
      </Modal>
